...
class MazeGame:
    ...
    def draw_maze(self, show_exploration=False):
        ...
        if self.creature.found_path:
            title = f'Maze Game - Dijkstra Pathfinding with Catmull-Rom Spline (Path Found: {len(self.creature.current_path)} points)'
        else:
    ...
    def run(self):
        ...
        print(f"[Dijkstra] Path found! Path length: {len(self.creature.current_path)} points")
